...
<script src="<?php echo assets('plugins/jquery-countto/jquery.countTo.js'); ?>"></script>

<!-- Morris Plugin Js -->
<script src="<?php echo assets('plugins/raphael/raphael.min.js'); ?>"></script>
<script src="<?php echo assets('plugins/morrisjs/morris.js'); ?>"></script>

<!-- Sparkline Chart Plugin Js -->
<script src="<?php echo assets('plugins/jquery-sparkline/jquery.sparkline.js'); ?>"></script>
...
<script src="<?php echo assets('admin/js/dashboard.js'); ?>"></script>

<!-- Demo Js -->
<script src="<?php echo assets('admin/js/demo.js') ?>"></script>

<!-- custom Js [last edit] -->
<script src="<?php echo assets('admin/js/custom.js'); ?>"></script>
