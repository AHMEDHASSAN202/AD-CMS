declare module 'sweetalert2' {
    ...
    namespace swal {
        ...
        /**
         * Hide validation errors message.
         */
        ...
        /**
         * An utility function to make SweetAlert rejections silencious (no errors in the console when clicking Cancel).
         * ex. swal(...).catch(swal.noop)
         */
        function noop(): void;
    }

    export type SweetAlertType = 'success'|'errors'|'warning'|'info'|'question'|undefined;
